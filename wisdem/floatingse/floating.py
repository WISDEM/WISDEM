...
class FloatingSE(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "main",
            Column(modeling_options=opt, column_options=opt["columns"]["main"], n_mat=n_mat),
        ...
        self.add_subsystem(
            "off",
            Column(modeling_options=opt, column_options=opt["columns"]["offset"], n_mat=n_mat),
        ...
        self.add_subsystem(
            "subs",
            Substructure(n_height_main=n_height_main, n_height_off=n_height_off, n_height_tow=n_height_tow),
            promotes=["*"],
        )
