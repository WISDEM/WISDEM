...
def assign_generator_values(wt_opt, modeling_options, nacelle):
    ...
    wt_opt['B_r']           = nacelle['generator']['B_r']
    wt_opt['P_Fe0e']        = nacelle['generator']['P_Fe0e']
    wt_opt['P_Fe0h']        = nacelle['generator']['P_Fe0h']
    wt_opt['S_N']           = nacelle['generator']['S_N']
    wt_opt['alpha_p']       = nacelle['generator']['alpha_p']
    wt_opt['b_r_tau_r']     = nacelle['generator']['b_r_tau_r']
    wt_opt['b_ro']          = nacelle['generator']['b_ro']
    wt_opt['b_s_tau_s']     = nacelle['generator']['b_s_tau_s']
    wt_opt['b_so']          = nacelle['generator']['b_so']
    wt_opt['cofi']          = nacelle['generator']['cofi']
    wt_opt['freq']          = nacelle['generator']['freq']
    wt_opt['h_i']           = nacelle['generator']['h_i']
    wt_opt['h_sy0']         = nacelle['generator']['h_sy0']
    wt_opt['h_w']           = nacelle['generator']['h_w']
    wt_opt['k_fes']         = nacelle['generator']['k_fes']
    wt_opt['k_fillr']       = nacelle['generator']['k_fillr']
    wt_opt['k_fills']       = nacelle['generator']['k_fills']
    wt_opt['k_s']           = nacelle['generator']['k_s']
    wt_opt['m']             = nacelle['generator']['m']
    wt_opt['mu_0']          = nacelle['generator']['mu_0']
    wt_opt['mu_r']          = nacelle['generator']['mu_r']
    wt_opt['p']             = nacelle['generator']['p']
    wt_opt['phi']           = nacelle['generator']['phi']
    wt_opt['q1']            = nacelle['generator']['q1']
    wt_opt['q2']            = nacelle['generator']['q2']
    wt_opt['ratio_mw2pp']   = nacelle['generator']['ratio_mw2pp']
    wt_opt['resist_Cu']     = nacelle['generator']['resist_Cu']
    wt_opt['sigma']         = nacelle['generator']['sigma']
    wt_opt['y_tau_p']       = nacelle['generator']['y_tau_p']
    wt_opt['y_tau_pr']      = nacelle['generator']['y_tau_pr']

    wt_opt['I_0']           = nacelle['generator']['I_0']
    wt_opt['d_r']           = nacelle['generator']['d_r']
    wt_opt['h_m']           = nacelle['generator']['h_m']
    wt_opt['h_0']           = nacelle['generator']['h_0']
    wt_opt['h_s']           = nacelle['generator']['h_s']
    wt_opt['len_s']         = nacelle['generator']['len_s']
    wt_opt['n_r']           = nacelle['generator']['n_r']
    wt_opt['rad_ag']        = nacelle['generator']['rad_ag']
    wt_opt['t_wr']          = nacelle['generator']['t_wr']

    wt_opt['n_s']           = nacelle['generator']['n_s']
    wt_opt['b_st']          = nacelle['generator']['b_st']
    wt_opt['d_s']           = nacelle['generator']['d_s']
    wt_opt['t_ws']          = nacelle['generator']['t_ws']

    wt_opt['rho_Copper']    = nacelle['generator']['rho_Copper']
    wt_opt['rho_Fe']        = nacelle['generator']['rho_Fe']
    wt_opt['rho_Fes']       = nacelle['generator']['rho_Fes']
    wt_opt['rho_PM']        = nacelle['generator']['rho_PM']

    wt_opt['C_Cu']          = nacelle['generator']['C_Cu']
    wt_opt['C_Fe']          = nacelle['generator']['C_Fe']
    wt_opt['C_Fes']         = nacelle['generator']['C_Fes']
    wt_opt['C_PM']          = nacelle['generator']['C_PM']

    if modeling_options['GeneratorSE']['type'] in ['pmsg_outer']:
        wt_opt['r_g']           = nacelle['generator']['r_g']
        wt_opt['N_c']           = nacelle['generator']['N_c']
        wt_opt['b']             = nacelle['generator']['b']
        wt_opt['c']             = nacelle['generator']['c']
        wt_opt['E_p']           = nacelle['generator']['E_p']
        wt_opt['h_yr']          = nacelle['generator']['h_yr']
        wt_opt['h_ys']          = nacelle['generator']['h_ys']
        wt_opt['h_sr']          = nacelle['generator']['h_sr']
        wt_opt['h_ss']          = nacelle['generator']['h_ss']
        wt_opt['t_r']           = nacelle['generator']['t_r']
        wt_opt['t_s']           = nacelle['generator']['t_s']

        wt_opt['u_allow_pcent'] = nacelle['generator']['u_allow_pcent']
        wt_opt['y_allow_pcent'] = nacelle['generator']['y_allow_pcent']
        wt_opt['z_allow_deg']   = nacelle['generator']['z_allow_deg']
        wt_opt['B_tmax']        = nacelle['generator']['B_tmax']

    if modeling_options['GeneratorSE']['type'] in ['eesg','pmsg_arms','pmsg_disc']:
        wt_opt['tau_p']         = nacelle['generator']['tau_p']
        wt_opt['h_ys']          = nacelle['generator']['h_ys']
        wt_opt['h_yr']          = nacelle['generator']['h_yr']
        wt_opt['b_arm']         = nacelle['generator']['b_arm']
        
    elif modeling_options['GeneratorSE']['type'] in ['scig','dfig']:
        wt_opt['B_symax']       = nacelle['generator']['B_symax']
