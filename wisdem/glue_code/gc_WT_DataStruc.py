...
class WindTurbineOntologyOpenMDAO(om.Group):
    ...
    def setup(self):
        ...
        if modeling_options['flags']['hub']:
            self.connect('configuration.n_blades', 'hub.n_blades')
            self.connect('blade.outer_shape_bem.chord', 'hub.blade_root_diameter', src_indices=[0])
...
class Hub_Diameter(om.ExplicitComponent):
    def setup(self):
