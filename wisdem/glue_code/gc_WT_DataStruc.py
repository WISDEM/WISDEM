...
class WindTurbineOntologyOpenMDAO(om.Group):
    ...
    def setup(self):
        ...
        if modeling_options['flags']['nacelle']:
            ...
            nacelle_ivc.add_output('brake_mass_coeff',   val=0.00122,     units='kg/N/m', desc='Regression-based scaling coefficient on rated torque to obtain brake mass')
            ...
            if modeling_options['flags']['generator']:
                ...
                generator_ivc.add_output('generator_mass_coeff', val=0.0)
