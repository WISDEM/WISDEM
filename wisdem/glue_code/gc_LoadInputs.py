    ...
    def write_ontology(self, wt_opt, fname_output):
        ...
        if self.modeling_options['Analysis_Flags']['DriveSE']:
            ...
            if self.modeling_options['flags']['generator']:
                ...
                self.wt_init['components']['nacelle']['generator']['B_r']         = float(wt_opt['B_r'])
                self.wt_init['components']['nacelle']['generator']['P_Fe0e']      = float(wt_opt['P_Fe0e'])
                self.wt_init['components']['nacelle']['generator']['P_Fe0h']      = float(wt_opt['P_Fe0h'])
                self.wt_init['components']['nacelle']['generator']['S_N']         = float(wt_opt['S_N'])
                self.wt_init['components']['nacelle']['generator']['alpha_p']     = float(wt_opt['alpha_p'])
                self.wt_init['components']['nacelle']['generator']['b_r_tau_r']   = float(wt_opt['b_r_tau_r'])
                self.wt_init['components']['nacelle']['generator']['b_ro']        = float(wt_opt['b_ro'])
                self.wt_init['components']['nacelle']['generator']['b_s_tau_s']   = float(wt_opt['b_s_tau_s'])
                self.wt_init['components']['nacelle']['generator']['b_so']        = float(wt_opt['b_so'])
                self.wt_init['components']['nacelle']['generator']['cofi']        = float(wt_opt['cofi'])
                self.wt_init['components']['nacelle']['generator']['freq']        = float(wt_opt['freq'])
                self.wt_init['components']['nacelle']['generator']['h_i']         = float(wt_opt['h_i'])
                self.wt_init['components']['nacelle']['generator']['h_sy0']       = float(wt_opt['h_sy0'])
                self.wt_init['components']['nacelle']['generator']['h_w']         = float(wt_opt['h_w'])
                self.wt_init['components']['nacelle']['generator']['k_fes']       = float(wt_opt['k_fes'])
                self.wt_init['components']['nacelle']['generator']['k_fillr']     = float(wt_opt['k_fillr'])
                self.wt_init['components']['nacelle']['generator']['k_fills']     = float(wt_opt['k_fills'])
                self.wt_init['components']['nacelle']['generator']['k_s']         = float(wt_opt['k_s'])
                self.wt_init['components']['nacelle']['generator']['m']           = float(wt_opt['m'] )
                self.wt_init['components']['nacelle']['generator']['mu_0']        = float(wt_opt['mu_0'])
                self.wt_init['components']['nacelle']['generator']['mu_r']        = float(wt_opt['mu_r'])
                self.wt_init['components']['nacelle']['generator']['p']           = float(wt_opt['p'] )
                self.wt_init['components']['nacelle']['generator']['phi']         = float(wt_opt['phi'])
                self.wt_init['components']['nacelle']['generator']['q1']          = float(wt_opt['q1'])
                self.wt_init['components']['nacelle']['generator']['q2']          = float(wt_opt['q2'])
                self.wt_init['components']['nacelle']['generator']['ratio_mw2pp'] = float(wt_opt['ratio_mw2pp'])
                self.wt_init['components']['nacelle']['generator']['resist_Cu']   = float(wt_opt['resist_Cu'])
                self.wt_init['components']['nacelle']['generator']['sigma']       = float(wt_opt['sigma'])
                self.wt_init['components']['nacelle']['generator']['y_tau_p']     = float(wt_opt['y_tau_p'])
                self.wt_init['components']['nacelle']['generator']['y_tau_pr']    = float(wt_opt['y_tau_pr'])

                self.wt_init['components']['nacelle']['generator']['I_0']         = float(wt_opt['I_0'])
                self.wt_init['components']['nacelle']['generator']['d_r']         = float(wt_opt['d_r'])
                self.wt_init['components']['nacelle']['generator']['h_m']         = float(wt_opt['h_m'])
                self.wt_init['components']['nacelle']['generator']['h_0']         = float(wt_opt['h_0'])
                self.wt_init['components']['nacelle']['generator']['h_s']         = float(wt_opt['h_s'])
                self.wt_init['components']['nacelle']['generator']['len_s']       = float(wt_opt['len_s'])
                self.wt_init['components']['nacelle']['generator']['n_r']         = float(wt_opt['n_r'])
                self.wt_init['components']['nacelle']['generator']['rad_ag']      = float(wt_opt['rad_ag'])
                self.wt_init['components']['nacelle']['generator']['t_wr']        = float(wt_opt['t_wr'])

                self.wt_init['components']['nacelle']['generator']['n_s']         = float(wt_opt['n_s'])
                self.wt_init['components']['nacelle']['generator']['b_st']        = float(wt_opt['b_st'])
                self.wt_init['components']['nacelle']['generator']['d_s']         = float(wt_opt['d_s'])
                self.wt_init['components']['nacelle']['generator']['t_ws']        = float(wt_opt['t_ws'])

                self.wt_init['components']['nacelle']['generator']['rho_Copper']  = float(wt_opt['rho_Copper'])
                self.wt_init['components']['nacelle']['generator']['rho_Fe']      = float(wt_opt['rho_Fe'])
                self.wt_init['components']['nacelle']['generator']['rho_Fes']     = float(wt_opt['rho_Fes'])
                self.wt_init['components']['nacelle']['generator']['rho_PM']      = float(wt_opt['rho_PM'])

                self.wt_init['components']['nacelle']['generator']['C_Cu']        = float(wt_opt['C_Cu'])
                self.wt_init['components']['nacelle']['generator']['C_Fe']        = float(wt_opt['C_Fe'])
                self.wt_init['components']['nacelle']['generator']['C_Fes']       = float(wt_opt['C_Fes'])
                self.wt_init['components']['nacelle']['generator']['C_PM']        = float(wt_opt['C_PM'])

                if self.modeling_options['GeneratorSE']['type'] in ['pmsg_outer']:
                    self.wt_init['components']['nacelle']['generator']['r_g']           = float(wt_opt['r_g'])
                    self.wt_init['components']['nacelle']['generator']['N_c']           = float(wt_opt['N_c'])
                    self.wt_init['components']['nacelle']['generator']['b']             = float(wt_opt['b'] )
                    self.wt_init['components']['nacelle']['generator']['c']             = float(wt_opt['c'] )
                    self.wt_init['components']['nacelle']['generator']['E_p']           = float(wt_opt['E_p'])
                    self.wt_init['components']['nacelle']['generator']['h_yr']          = float(wt_opt['h_yr'])
                    self.wt_init['components']['nacelle']['generator']['h_ys']          = float(wt_opt['h_ys'])
                    self.wt_init['components']['nacelle']['generator']['h_sr']          = float(wt_opt['h_sr'])
                    self.wt_init['components']['nacelle']['generator']['h_ss']          = float(wt_opt['h_ss'])
                    self.wt_init['components']['nacelle']['generator']['t_r']           = float(wt_opt['t_r'])
                    self.wt_init['components']['nacelle']['generator']['t_s']           = float(wt_opt['t_s'])

                    self.wt_init['components']['nacelle']['generator']['u_allow_pcent'] = float(wt_opt['u_allow_pcent'])
                    self.wt_init['components']['nacelle']['generator']['y_allow_pcent'] = float(wt_opt['y_allow_pcent'])
                    self.wt_init['components']['nacelle']['generator']['z_allow_deg']   = float(wt_opt['z_allow_deg'])
                    self.wt_init['components']['nacelle']['generator']['B_tmax']        = float(wt_opt['B_tmax'])

                if self.modeling_options['GeneratorSE']['type'] in ['eesg','pmsg_arms','pmsg_disc']:
                    self.wt_init['components']['nacelle']['generator']['tau_p']         = float(wt_opt['tau_p'])
                    self.wt_init['components']['nacelle']['generator']['h_ys']          = float(wt_opt['h_ys'])
                    self.wt_init['components']['nacelle']['generator']['h_yr']          = float(wt_opt['h_yr'])
                    self.wt_init['components']['nacelle']['generator']['b_arm']         = float(wt_opt['b_arm'])

                elif self.modeling_options['GeneratorSE']['type'] in ['scig','dfig']:
                    self.wt_init['components']['nacelle']['generator']['B_symax']       = float(wt_opt['B_symax'])
