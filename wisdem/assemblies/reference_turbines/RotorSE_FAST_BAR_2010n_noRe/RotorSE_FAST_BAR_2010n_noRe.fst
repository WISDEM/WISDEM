...
0                      CompIce     - 
---------------------- INPUT FILES ---------------------------------------------
"RotorSE_FAST_BAR_2010n_noRe_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"RotorSE_FAST_BAR_2010n_noRe_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"RotorSE_FAST_BAR_2010n_noRe_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"RotorSE_FAST_BAR_2010n_noRe_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
