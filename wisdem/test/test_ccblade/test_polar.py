...
class Test3DStall(unittest.TestCase):
    ...
    def test_stall1(self):
        ...
        cl_3d = [-0.802     , -0.721     , -0.611     , -0.506     , -0.408     ,
       -0.313     , -0.22      , -0.133     , -0.06      ,  0.036     ,
        0.22699889,  0.34177831,  0.43571291,  0.55420622,  0.68375956,
        0.72989395,  0.80396589,  0.89595271,  0.98120396,  1.06378525,
        1.14521114,  1.20948854,  1.26804979,  1.32832588,  1.37316833,
        1.30883209,  1.31594788,  1.35335932,  1.40105986,  1.45161848,
        1.91376181,  0.757     ,  0.7]
        # # Du Selig method
        cd_3d = [0.027     , 0.025     , 0.024     , 0.023     , 0.022     ,
       0.022     , 0.023     , 0.025     , 0.027     , 0.028     ,
       0.02400011, 0.01901878, 0.01701928, 0.01508907, 0.01726512,
       0.01878091, 0.0211179 , 0.02533226, 0.03032251, 0.03705574,
       0.04660975, 0.06111659, 0.08033642, 0.10480582, 0.1303095 ,
       0.16980475, 0.20446535, 0.23851947, 0.27299211, 0.30779013,
       0.80935111, 0.525     , 0.742]
        # test equality
    ...
    def test_stall2(self):
        ...
        cl_3d = [-0.802     , -0.721     , -0.611     , -0.506     , -0.408     ,
       -0.313     , -0.22      , -0.133     , -0.06      ,  0.036     ,
        0.22699972,  0.34194432,  0.43592789,  0.55554944,  0.68993016,
        0.71874108,  0.77179222,  0.84656608,  0.91515517,  0.98157599,
        1.04620895,  1.08406997,  1.113007  ,  1.14462124,  1.15214072,
        0.98921218,  0.93783339,  0.9337517 ,  0.94573318,  0.96217664,
        1.05878905,  0.757     ,  0.7]
        # # Du Selig method
        cd_3d = [0.027     , 0.025     , 0.024     , 0.023     , 0.022     ,
       0.022     , 0.023     , 0.025     , 0.027     , 0.028     ,
       0.02400003, 0.01900472, 0.01700484, 0.01502237, 0.01706659,
       0.01894497, 0.02102962, 0.02433464, 0.02783455, 0.03252109,
       0.03941379, 0.049797  , 0.06361049, 0.08173784, 0.09862735,
       0.11828246, 0.13672319, 0.15576041, 0.17490275, 0.193378  ,
       0.4436646 , 0.525     , 0.742]
    ...
    def test_stall3(self):
        ...
        cl_3d = [-0.802     , -0.721     , -0.611     , -0.506     , -0.408     ,
       -0.313     , -0.22      , -0.133     , -0.06      ,  0.036     ,
        0.22699945,  0.34189115,  0.43585904,  0.55511924,  0.68795386,
        0.72231309,  0.78209671,  0.86238349,  0.93630909,  1.00790573,
        1.07791708,  1.12423867,  1.16266366,  1.20345763,  1.22293081,
        1.09157913,  1.05893482,  1.06814243,  1.0915639 ,  1.11893367,
        1.33261727,  0.757     ,  0.7]
        # # Du Selig method
        cd_3d = [0.027     , 0.025     , 0.024     , 0.023     , 0.022     ,
        0.022     , 0.023     , 0.025     , 0.027     , 0.028     ,
        0.02400006, 0.01900922, 0.01700947, 0.01504374, 0.01713018,
        0.01889242, 0.02105789, 0.02465415, 0.02863139, 0.03397343,
        0.04171849, 0.05342241, 0.06896742, 0.08912599, 0.10877442,
        0.13478387, 0.15841946, 0.18226624, 0.20631853, 0.23002159,
        0.56078563, 0.525     , 0.742 ]
