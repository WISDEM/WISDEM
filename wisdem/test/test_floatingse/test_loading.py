...
def getInputs():
    ...
    colz = np.r_[np.linspace(-15, -10, 7)[:-1], np.linspace(-10, 0, 4)[:-1], np.linspace(0, 10, 7)]
    ...
    colz = np.r_[np.linspace(-15, 0, 10)[:-1], np.linspace(0, 2.5, 4)[:-1], np.linspace(2.5, 10, 4)]
                        ...
                        for lrp in [True, False]:
                            ...
                            for urp in [True, False]:
                                ...
                                for ocp in [True, False]:
                                    ...
                                    if (nc > 0) and (not cap) and (not lap) and (not uap):
                                        continue
