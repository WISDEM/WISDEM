...
class TestGearbox(unittest.TestCase):
    ...
    def testEEP(self):
        ...
        npt.assert_almost_equal(self.outputs['gearbox_I'][1:], self.outputs['gearbox_mass']*(0.75*self.outputs['D_gearbox']**2+self.outputs['L_gearbox']**2)/12.)
        self.assertEqual(self.outputs['L_gearbox'], 0.012*126.0)
        self.assertEqual(self.outputs['D_gearbox'], 0.75*0.015*126.)
    ...
    def testLargeMachine(self):
        ...
        self.assertEqual(self.outputs['D_gearbox'], 0.75*0.015*200.)
