...
class TestRegression(unittest.TestCase):
    def test15MW(self):
        ...
        self.assertAlmostEqual(wt_opt["rotorse.re.precomp.blade_mass"][0], 73564.2030305420, 1)
        self.assertAlmostEqual(wt_opt["rotorse.rp.AEP"][0] * 1.0e-6, 78.1538730538, 1)
        self.assertAlmostEqual(wt_opt["financese.lcoe"][0] * 1.0e3, 82.3988604166, 1)
        self.assertAlmostEqual(wt_opt["rotorse.rs.tip_pos.tip_deflection"][0], 25.0114335588, 1)
