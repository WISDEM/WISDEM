...
class TestRC(unittest.TestCase):
    ...
    def testRotorCostIEA3p4(self):
        ...
        self.assertAlmostEqual(wt_opt["rc.total_labor_hours"][0], 942.25594411, places=accuracy)
        ...
        self.assertAlmostEqual(wt_opt["rc.total_cost_tooling"][0], 9973.06061433774, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_building"][0], 544.3309392, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_maintenance_cost"][0], 3582.6822627320657, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_labor_overhead"][0], 9537.8106675634, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.cost_capital"][0], 7223.847351785511, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.blade_fixed_cost"][0], 34196.2204291149, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_blade_cost"][0], 136373.2105087838, places=accuracy)
    ...
    def testRotorCostIEA10(self):
        ...
        self.assertAlmostEqual(wt_opt["rc.total_cost_tooling"][0], 34037.02892730745, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_building"][0], 1960.741347506985, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_maintenance_cost"][0], 10989.1728047334, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_labor_overhead"][0], 21344.571125455346, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.cost_capital"][0], 21353.81926150578, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.blade_fixed_cost"][0], 97661.22986489852, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_blade_cost"][0], 367368.15794222674, places=accuracy)
    ...
    def testRotorCostIEA15(self):
        ...
        self.assertAlmostEqual(wt_opt["rc.total_cost_tooling"][0], 32368.053976900293, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_building"][0], 2373.102687509132, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_maintenance_cost"][0], 18208.58755949735, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_labor_overhead"][0], 31871.68193444645, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.cost_capital"][0], 35779.70512019253, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.blade_fixed_cost"][0], 146056.0705240016, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_blade_cost"][0], 616948.183790402, places=accuracy)
