...
class TestBC(unittest.TestCase):
    ...
    def testBladeCostBAR_USC(self):
        ...
        self.assertAlmostEqual(wt_opt["rc.total_labor_hours"][0], 1927.7917436423027, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_non_gating_ct"][0], 216.48813756723342, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_metallic_parts_cost"][0], 6482.081656404547, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_consumable_cost_w_waste"][0], 9544.750659016909, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_blade_mat_cost_w_waste"][0], 291145.97155238746, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_labor"][0], 114083.18409255406, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_utility"][0], 2070.1239297046773, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.blade_variable_cost"][0], 407299.27957464615, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_equipment"][0], 10789.006912069297, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_tooling"][0], 21493.114049038515, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_cost_building"][0], 1194.2378082155187, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_maintenance_cost"][0], 9187.586382532503, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_labor_overhead"][0], 34224.955227766215, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.cost_capital"][0], 21104.295122252643, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.blade_fixed_cost"][0], 97993.1955018747, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc.total_blade_cost"][0], 505292.4750765208, places=accuracy)
