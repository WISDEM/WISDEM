...
class TestBC(unittest.TestCase):
    ...
    def testBladeCostBAR_USC(self):
        ...
        self.assertAlmostEqual(wt_opt["rc_in.total_labor_hours"][0], 1769.4849766146888, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_non_gating_ct"][0], 194.48893570485987, places=accuracy)
        ...
        self.assertAlmostEqual(wt_opt["rc_in.total_cost_labor"][0], 59789.85229687738, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_cost_utility"][0], 1851.3571210340756, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.blade_variable_cost"][0], 342275.4237437732, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_cost_equipment"][0], 9890.121315594875, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_cost_tooling"][0], 17156.69264865687, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_cost_building"][0], 844.111489477112, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_maintenance_cost"][0], 7714.0531373955855, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_labor_overhead"][0], 17936.955689063216, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.cost_capital"][0], 17495.37847036958, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.blade_fixed_cost"][0], 71037.31275055723, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_in.total_blade_cost"][0], 413312.73649433046, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_labor_hours"][0], 342.0510053019569, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_non_gating_ct"][0], 68.94788352567306, places=accuracy)
        ...
        self.assertAlmostEqual(wt_opt["rc_out.total_cost_labor"][0], 11514.62690882713, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_cost_utility"][0], 165.95050276105664, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.blade_variable_cost"][0], 42015.3914604367, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_cost_equipment"][0], 1416.2161291967027, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_cost_tooling"][0], 2510.9560206969245, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_cost_building"][0], 177.03733360230407, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_maintenance_cost"][0], 1180.6842153129544, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_labor_overhead"][0], 3454.388072648139, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.cost_capital"][0], 2537.451542659797, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.blade_fixed_cost"][0], 11276.733314116822, places=accuracy)
        self.assertAlmostEqual(wt_opt["rc_out.total_blade_cost"][0], 53292.12477455352, places=accuracy)
        self.assertAlmostEqual(wt_opt["total_bc.total_blade_cost"][0], 485204.861268884, places=accuracy)
