...
class TestAll(unittest.TestCase):
    ...
    def testMass(self):
        ...
        self.assertAlmostEqual(float(prob['spinner_mass']), 973., 2)
    ...
    def testMassAndCost(self):
        ...
        self.assertAlmostEqual(float(prob['generator_cost']), 184760., 2)
        ...
        self.assertAlmostEqual(float(prob['hvac_cost']), 49600., 2)
        self.assertAlmostEqual(float(prob['controls_cost']), 105750., 2)
        self.assertAlmostEqual(float(prob['converter_cost']), 0., 2)
        self.assertAlmostEqual(float(prob['elec_cost']), 209250., 2)
