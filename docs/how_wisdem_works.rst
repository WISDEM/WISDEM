...
Full wind plants are comprised of multiple subsystems with varying degrees of technical complexity and many interfaces between many stakeholders.  Integrated Systems Design and Analysis (ISDA) is required to assess system impacts and optimize for cost and performance.  The Wind-plant Integrated System Design and Engineering Model (WISDEM) is an opensource software package that aimes to meet these challenges and empower researcher to meet the following objects:
