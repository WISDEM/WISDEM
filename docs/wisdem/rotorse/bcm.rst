...
The blade cost model is implemented in the file rotor_cost.py and it is called in the file rotor_elasticity.py

.. literalinclude:: ../../../wisdem/rotorse/rotor_elasticity.py
    :start-after:        # Rotor cost
    :end-before:class RotorElasticity(Group):