...
A new methodology was developed that is provably convergent in every instance (see :ref:`theory`).
...
The Fortran code is called from Python as an extension module using `f2py <http://www.scipy.org/F2py/>`_.
