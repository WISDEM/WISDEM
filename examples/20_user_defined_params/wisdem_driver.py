...
values_to_check = {
    ...
    'drivese.hub_system_I':  [973520., 619970., 619970., 0.0, 0.0, 0.0],
    'drivese.generator_rotor_I': [9912933., 10862815., 10360761.],
    'drivese.above_yaw_mass':  [675175.0],
    'drivese.yaw_mass':  [0],
    'drivese.above_yaw_cm': [-4.528, -0.14 ,  4.098],
    'drivese.above_yaw_I_TT': [ 9912933., 10862815., 10360761., 0.0, 0.0, 0.0],
    'drivese.above_yaw_I': [ 9912933., 10862815., 10360761., 0.0, 0.0, 0.0],
