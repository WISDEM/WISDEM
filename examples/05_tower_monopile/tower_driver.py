...
print("Tower base forces1 (N) =", wt_opt["towerse.tower1.turbine_F"])
print("Tower base moments1 (Nm) =", wt_opt["towerse.tower1.turbine_M"])
...
print("Tower base forces2 (N) =", wt_opt["towerse.tower2.turbine_F"])
print("Tower base moments2 (Nm) =", wt_opt["towerse.tower2.turbine_M"])
