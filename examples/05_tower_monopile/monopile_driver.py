...
print("mass (kg) =", wt_opt["fixedse.tower_mass"])
print("cg (m) =", wt_opt["fixedse.tower_center_of_mass"])
...
print("freq (Hz) =", wt_opt["fixedse.tower1.structural_frequencies"])
print("Fore-aft mode shapes =", wt_opt["fixedse.tower1.fore_aft_modes"])
print("Side-side mode shapes =", wt_opt["fixedse.tower1.side_side_modes"])
print("top_deflection1 (m) =", wt_opt["fixedse.tower1.top_deflection"])
print("Tower base forces1 (N) =", wt_opt["fixedse.tower1.mudline_F"])
print("Tower base moments1 (Nm) =", wt_opt["fixedse.tower1.mudline_M"])
...
print("freq (Hz) =", wt_opt["fixedse.tower2.structural_frequencies"])
print("Fore-aft mode shapes =", wt_opt["fixedse.tower2.fore_aft_modes"])
print("Side-side mode shapes =", wt_opt["fixedse.tower2.side_side_modes"])
print("top_deflection2 (m) =", wt_opt["fixedse.tower2.top_deflection"])
print("Tower base forces2 (N) =", wt_opt["fixedse.tower2.mudline_F"])
print("Tower base moments2 (Nm) =", wt_opt["fixedse.tower2.mudline_M"])
