...
fname_wt_input1         = mydir + os.sep + 'blade.yaml'
fname_wt_input2         = mydir + os.sep + 'output' + os.sep + 'blade_optimized.yaml'
fname_modeling_options = mydir + os.sep + 'modeling_options.yaml'
fname_analysis_options = mydir + os.sep + 'analysis_options_blade_no_opt.yaml'
folder_output          = mydir + os.sep + 'output' + os.sep
fname_wt_output        = folder_output + 'temp.yaml'


wt_opt1, analysis_options1, opt_options1 = run_wisdem(fname_wt_input1, fname_modeling_options, fname_analysis_options, fname_wt_output, folder_output)
wt_opt2, analysis_options2, opt_options2 = run_wisdem(fname_wt_input2, fname_modeling_options, fname_analysis_options, fname_wt_output, folder_output)
...
# print(np.max(wt_opt1['elastic.rail.constr_LV_4axle_horiz']))
# print(np.max(wt_opt1['elastic.rail.constr_LV_8axle_horiz']))
# print(np.max(wt_opt1['elastic.rail.constr_LV_4axle_vert']))
# print(np.max(wt_opt1['elastic.rail.constr_LV_8axle_vert']))
# print(np.max(wt_opt1['elastic.rail.constr_strainPS']))
# print(np.max(wt_opt1['elastic.rail.constr_strainSS']))
# print(np.max(wt_opt1['elastic.rail.constr_strainLE']))
# print(np.max(wt_opt1['elastic.rail.constr_strainTE']))

# print(np.max(wt_opt2['elastic.rail.constr_LV_4axle_horiz']))
# print(np.max(wt_opt2['elastic.rail.constr_LV_8axle_horiz']))
# print(np.max(wt_opt2['elastic.rail.constr_LV_4axle_vert']))
# print(np.max(wt_opt2['elastic.rail.constr_LV_8axle_vert']))
# print(np.max(wt_opt2['elastic.rail.constr_strainPS']))
# print(np.max(wt_opt2['elastic.rail.constr_strainSS']))
# print(np.max(wt_opt2['elastic.rail.constr_strainLE']))
# print(np.max(wt_opt2['elastic.rail.constr_strainTE']))
