...
htmlhelp_basename = 'AirfoilPreppydoc'
...
latex_documents = [
  ('index', 'AirfoilPreppy.tex', u'AirfoilPrep.py Documentation',
   u'S. Andrew Ning', 'manual'),
]
...
man_pages = [
    ('index', 'AirfoilPreppy', u'AirfoilPreppy Documentation',
     [u'S. Andrew Ning'], 1)
]
...
texinfo_documents = [
  ('index', 'AirfoilPreppy', u'AirfoilPreppy Documentation',
   u'S. Andrew Ning', 'AirfoilPreppy', 'One line description of project.',
   'Miscellaneous'),
]
