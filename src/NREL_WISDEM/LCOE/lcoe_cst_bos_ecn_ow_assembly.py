...
class lcoe_cst_bos_ecn_ow_assembly(Assembly):
    ...
    def configure(self):
        ...
        # turbine configuration
        # drivetrain
        self.connect('machine_rating', ['tcc.machine_rating', 'bos.machine_rating', 'opex.machine_rating', 'fin.machine_rating', 'aep.machine_rating'])
        ...
        # plant configuration
        # climate
        #self.connect('shear_exponent',['aep.shear_exponent']) # unnecessary for openwind
        ...
        #self.connect('array_losses', ['aep.array_losses']) # not needed for openwind connection
        self.connect('turbine_number', ['bos.turbine_number', 'opex.turbine_number', 'fin.turbine_number', 'aep.turbine_number'])
        ...
        self.connect('tcc.rotor_diameter', ['bos.rotor_diameter', 'aep.rotor_diameter'])
        self.connect('tcc.hub_height', ['bos.hub_height']) # , 'aep.hub_height' # todo: hub height can't be adjusted at present
