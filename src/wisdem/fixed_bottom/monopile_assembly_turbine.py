...
if __name__ == '__main__':
    ...
    prob = Problem(root=MonopileTurbine(nsection, RefBlade))
    ...
    prob['air_density']                    = 1.198
    prob['air_viscosity']                  = 1.81e-5
    ...
    prob['tower_wall_thickness']           = np.linspace(0.027, 0.019, nsection+1)
    ...
    # For turbine costs, substitute for using DriveSE
    ...
    prob['cover_mass']           = 1e3
    prob['platforms_mass']       = 1e3
    prob['pitch_system_mass']    = 17004.0
    prob['spinner_mass']         = 1810.5
    prob['transformer_mass']     = 1e3
    prob['vs_electronics_mass']  = 1e3
