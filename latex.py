...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    default_elements = {
        ...
        'makeindex':       '\\makeindex',
        'shorthandoff':    '',
        # 'executivesummary': '\\chapter*{Executive Summary}\n[content here]\\\\\n\\vspace{1em}\n\\releasename: \\version\n\\clearpage',
        'maketitle':       '\\maketitle',
        'tableofcontents': '\\renewcommand{\contentsname}{Table of Contents}\n\\tableofcontents',
        'listoffigs':      '\\clearpage\n\\listoffigures\n\\listoftables',
        'footer':          '',
        'printindex':      '\\printindex',
        'romannumbering':   '\\pagenumbering{roman}\n\\setcounter{page}{3}\n',
        'arabicnumbering':  '\\clearpage\n\\pagenumbering{arabic}\n'
    }
    ...
    def __init__(self, document, builder):
        ...
        self.thisisnotthefirstrow = False
    ...
    def depart_table(self, node):
        ...
        if self.table.longtable:
            ...
            # A. Ning
            self.body.append('\n\\begin{table}[htb]\\centering\n\\caption{***PUT CAPTION HERE***}\\begin{tabular}')
        ...
        if self.table.colspec:
            ...
            # A.Ning
            self.body.append('{>{\\raggedright\\arraybackslash}p{0.42\\textwidth}@{\qquad}p{0.45\\textwidth}}')
        else:
    ...
    def visit_row(self, node):
        self.table.col = 0
        if self.thisisnotthefirstrow:
            self.body.append('\\\\\\midrule\n')
        else:
            self.thisisnotthefirstrow = True
    ...
    def visit_term(self, node):
        ctx = '}] \\leavevmode\\\\'  # modified a.ning
        if node.get('ids'):
    ...
    def visit_reference(self, node):
        ...
        if self.in_title or not uri:
            ...
            if hashindex == -1:
                ...
                # added a.ning 5/7/2013 to fix bibliography linking error
                number = node.astext().replace('[', '').replace(']', '')
                if number.isdigit():
                    self.body.append('\\citep{' + id.split(':')[1] + '}')
                    self.context.append('')
                    return
                    # id = id.split(':')[0] + ':' + number
